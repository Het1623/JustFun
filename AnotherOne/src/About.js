...
export default function About() {
   const [myBtn, setMyBtn] = useState(<span class="material-symbols-outlined my-3 mx-3">
   dark_mode
   </span>)
    ...
    const changeColor = ()=>{
        if(darkMode.color === 'black'){
            ...
            setMyBtn(<span class="material-symbols-outlined my-3 mx-3">light_mode</span>)
        ...
        setMyBtn(<span class="material-symbols-outlined my-3 mx-3">
        dark_mode
        </span>)
    }
}
  ...
  <div className="accordion-item" style={darkMode}>
    ...
    <button type="button" className="btn btn-dark" onClick={changeColor}>{myBtn}</button>
    </div>
